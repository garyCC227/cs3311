...
as
select room,day,starting,ending, BinaryORrows(weeks) as weeks from T3rooms 
group by room, day, starting, ending;

create or replace view T2Rooms2
as
select room,day,starting,ending, BinaryORrows(weeks) as weeks from T2rooms 
group by room, day, starting, ending;

create or replace view T1Rooms2
as
select room,day,starting,ending, BinaryORrows(weeks) as weeks from T1rooms 
group by room, day, starting, ending;
